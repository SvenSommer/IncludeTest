...
CAUTION: DEPRECATED KBV-Bundle, zulässig bis 30.06.2023
    ...
    <entry>
        ...
        <resource>
            <Composition xmlns="http://hl7.org/fhir">
                ...
                <meta>
                    <profile value="https://fhir.kbv.de/StructureDefinition/KBV_PR_ERP_Composition\|1.1" />
                </meta>
    ...
    <entry>
        ...
        <resource>
            <Medication xmlns="http://hl7.org/fhir">
                ...
                <meta>
                    <profile value="https://fhir.kbv.de/StructureDefinition/KBV_PR_ERP_Medication_Ingredient\|1.0.2" />
                </meta>
